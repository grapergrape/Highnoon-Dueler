...
export const CLASSES = [
  ...
  },
  {
    ...
    abilityBlurb: "Each duel win earns Respect (cap 10): +4 max HP per point. While above 100 current HP, shotgun accuracy gains +3% per HP (max +25%).",
    startingMaxHp: 100,
  ...
  },
  {
    ...
    abilityBlurb: "Starts each duel dual-wielding. First gun card each duel is free and replaces the off-hand. Magazines stack, damage/accuracy average, -5% accuracy until steadied. +10 HP/duel.",
    startingMaxHp: 110,
    starterDeckIds: [...VAQUERO_STARTER_DECK],
    permanent: {
      healPerDuel: 10,
      dualWieldEnabled: true,
      dualWieldAccPenalty: 0.05,
  ...
  },
  {
    ...
    abilityBlurb: "+1 Nerve each prep round. Spend HP for tempo and life-stealing blood rounds. At 60% HP or lower: +20% acc, +6 damage, and first 3 shots auto-hit. Quickdraw ties are wins, healing 30% max HP.",
    startingMaxHp: 120,
    starterDeckIds: [...BOUNTY_HUNTER_STARTER_DECK],
    permanent: {
      quickdrawWin: true,
      quickdrawHealPct: 0.30,
      focusPerRound: 1,
      brinkThresholdPct: 0.60,
      brinkAccBonus: 0.20,
      brinkDamageBonus: 6,
      brinkFirstHitsAuto: 3,
    },
    portraitTint: "#3d2e22",
  },
];
